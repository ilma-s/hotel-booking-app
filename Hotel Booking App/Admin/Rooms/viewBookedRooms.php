...
if(!isset($_SESSION['userAdmin']) || $_SESSION['userAdmin'] == 0) {
    ...
    if(mysqli_num_rows($bookedRoomsResult) == 0) {
        ?>
        <h1 class="warning">No currently booked rooms!</h1>
        <h3 class="warning">You can view all your available rooms <a href="viewAvailableRooms.php" class="logIn">here.</a></h3>
        <?php
        exit();
    }
...
<main>
    <div class="table-wrapper">
        <table class="fl-table">
            ...
            <tbody>
            <?php
            while($row = mysqli_fetch_assoc($bookedRoomsResult)): ?>
                <tr>
